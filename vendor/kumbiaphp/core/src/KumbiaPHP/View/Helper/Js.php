...
class Js extends AbstractHelper
{
    ...
    public static function link($action, $text, $confirm = '¿Está Seguro?', $class = NULL, $attrs = NULL)
    {
        ...
        return '<a href="' . "$action\" title=\"$confirm\" class=\"js-confirm $class\" $attrs>$text</a>";
    }
    ...
    public static function submitImage($img, $confirm = '¿Está Seguro?', $class = NULL, $attrs = NULL)
    {
        ...
        return "<input type=\"image\" title=\"$confirm\" src=\"" . self::$app->getBaseUrl() . "img/$img\" class=\"js-confirm $class\" $attrs/>";
    }
